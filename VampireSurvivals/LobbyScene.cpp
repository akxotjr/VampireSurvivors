...
void LobbyScene::Init()
{
	...
	ResourceManager::GetInstance()->LoadFont(L"Title-Font", L"Font\\FantasyRPGtitle (size 11).ttf");
	ResourceManager::GetInstance()->LoadFont(L"Text-Font", L"Font\\FantasyRPGtext (size 8).ttf");
...
void LobbyScene::Render(HDC hdc)
{
	...
	{
		HFONT hFont = ResourceManager::GetInstance()->GetFont(L"Text-Font");
